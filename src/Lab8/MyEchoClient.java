...
public class MyEchoClient {
	...
	public static void main(String[] args) throws IOException {
		...
		/*
		 * try { echoSocket = new Socket("szymon.ia.agh.edu.pl", 3000); out =
		 ...
		 * "the connection to: localhost."); System.exit(1); }
		 * 
		 * BufferedReader stdIn = new BufferedReader(new InputStreamReader(
		 * System.in)); String userInput;
		 * 
		 * System.out.println("Type a message: "); while ((userInput =
		 * stdIn.readLine()) != null) { out.println(userInput);
